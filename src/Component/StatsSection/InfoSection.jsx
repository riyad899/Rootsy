...
const InfoSection = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-green-50 to-white py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden ">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 right-20 w-24 h-24 bg-green-200 rounded-full opacity-40 animate-bounce" style={{animationDelay: '1s'}}></div>
        <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-green-300 rounded-full opacity-20 animate-ping" style={{animationDelay: '2s'}}></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className={`text-center mb-12 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className={`text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
            We at the <span className="font-semibold text-green-700 px-2 py-1 bg-green-100 rounded-md">Gawley</span> are proud of our carefully designed landscapes tailored to suit our commercial clients' preferences while providing sustainability.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-16">
          ...
          <div className={`text-center transform transition-all duration-800 delay-500 ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-10 scale-95'}`}>
            <div className="relative group">
              <div ref={yearsRef} className="text-6xl font-bold text-green-700 mb-2 transition-all duration-300 group-hover:scale-110 group-hover:text-green-600">0</div>
              <div className="absolute inset-0 bg-green-200 rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-300 transform scale-125"></div>
            </div>
          ...
          <div className={`text-center relative transform transition-all duration-800 delay-700 ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-10 scale-95'}`}>
            ...
            <div className="z-10 relative group">
              <div className="relative">
                <div ref={specialistsRef} className="text-6xl font-bold text-green-700 mb-2 transition-all duration-300 group-hover:scale-110 group-hover:text-green-600">0</div>
                <div className="absolute inset-0 bg-green-200 rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-300 transform scale-125"></div>
              </div>
          ...
          <div className={`text-center transform transition-all duration-800 delay-900 ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-10 scale-95'}`}>
            <div className="relative group">
              <div ref={awardsRef} className="text-6xl font-bold text-green-700 mb-2 transition-all duration-300 group-hover:scale-110 group-hover:text-green-600">0</div>
              <div className="absolute inset-0 bg-green-200 rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-300 transform scale-125"></div>
            </div>
        ...
        <div className={`mt-16 text-center transition-all duration-1000 delay-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="inline-flex items-center space-x-2 px-6 py-3 bg-green-100 rounded-full hover:bg-green-200 transition-colors duration-300 cursor-pointer group">
            <span className="text-green-700 font-medium">Discover Our Portfolio</span>
