  ...
  return (
    <div className="mt-[110px] max-w-5xl mx-auto px-4 py-8 bg-gray-50 min-h-screen">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">{gardeners.length} gardeners in your community</p>
          </div>
          <div className="flex space-x-2">
            <button className="px-4 py-2 text-white rounded-lg hover:opacity-90 transition-colors duration-200 text-sm font-medium" style={{backgroundColor: '#00C950'}}>
              Find Friends
            </button>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex space-x-2 ml-4">
                      <button className="px-4 py-2 text-white text-sm font-medium rounded-lg hover:opacity-90 transition-colors duration-200" style={{backgroundColor: '#00C950'}}>
                        Message
                      </button>
      ...
      <div className="mt-6 text-center">
        <button className="px-6 py-3 bg-gray-200 text-gray-700 rounded-[70px] hover:bg-gray-300 transition-colors duration-200 font-medium">
          Load More Gardeners
        </button>
      </div>
    </div>
