      ...
      {activeTab === 'analytics' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="border-t pt-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="border rounded-lg p-4">
                  ...
                  <button className="mt-2 text-[#089579] font-medium text-sm">Start a post</button>
                </div>
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <button className="mt-2 text-[#089579] font-medium text-sm">Comment on feed</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 border-l-4 border-[#089579]">
            ...
            <button className="bg-[#089579] text-white px-4 py-2 rounded-lg hover:bg-[#067a60] transition">
      ...
      {activeTab === 'community' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 border-l-4 border-[#089579]">
            ...
            {tips.map(tip => (
              <div key={tip.id} className="border-b py-4">
                ...
                <button className="mt-2 text-[#089579] text-sm font-medium">View details</button>
              </div>
            ))}
            <button className="mt-4 text-[#089579] font-medium">View all tips →</button>
          </div>
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 border-l-4 border-[#089579]">
            ...
            <button className="mt-4 text-[#089579] font-medium">View all followers →</button>
          </div>
        </div>
      )}
